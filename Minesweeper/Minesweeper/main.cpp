...
#include<string>
#include<cstdlib>
#include<conio.h>//DA UNOSIS BEZ ENTERA
#include<windows.h>//SISTEM PAUZE.... SAMO CODEBLOCKS
using namespace std;

char p(string x);//OUTPUT RAZNIH KARAKTERA //DEKLARACIJE FUNKCIJAAA
int duz(int l);//MJERI DUZINU BROJEVA(CIFRE), NISTA VISE
...
int main(){
    ...
    while(true){
        ...
        if(choice=='5')
            ...
            cout<<"\n\n Close 'Instructions' file to continue!\n ";
            system("instructions.docx");
            cout<<"\n\n Press any key to go back!\n\n ";
            any=getch();
        }
        else if(choice=='2'){
